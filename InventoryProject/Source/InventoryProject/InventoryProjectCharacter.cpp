...
AInventoryProjectCharacter::AInventoryProjectCharacter(const FObjectInitializer& ObjectInitializer): Super(ObjectInitializer)
{
	ItemComponent = CreateDefaultSubobject<UZItemComponent>(TEXT("ItemComponent"));
	SceneInteractComponent = CreateDefaultSubobject<UZSceneInteractComponent>(TEXT("SceneInteractComponent"));
